...
export class BonusStage extends Scene {
    ...
    init(data) {
        // Recibir las coordenadas del jugador desde Level1
    ...
    create() {
        ...
        // ── Tilemap ──────────────────────────────────────────────────────
        this.map = this.make.tilemap({ key: 'map_bonusstage1' });
        ...
        console.log(`BonusStage iniciado. Jugador en: ${this.playerSpawnX}, ${this.playerSpawnY}`);
...
this.physics.add.overlap(
    ...
    (player, item) => {
        ...
        console.log('¡Berenjena recolectada!');
    }
);
    ...
    update() {
        ...
        if (this.player.sprite.y > camBottom && !this.player.isDying) {
            console.log('¡Jugador se cayó en BonusStage! Game Over directo.');            // Detener música
